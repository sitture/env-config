...
import static com.github.sitture.envconfig.EnvConfigProperties.CONFIG_ENV_DEFAULT;
import static com.github.sitture.envconfig.EnvConfigProperties.CONFIG_ENV_KEY;
import static com.github.sitture.envconfig.EnvConfigProperties.CONFIG_ENV_PROFILE_KEY;
...
class EnvConfigProfileTest {
	...
	private void setProfile(final String profile) {
		System.setProperty(CONFIG_ENV_PROFILE_KEY, profile);
	}
